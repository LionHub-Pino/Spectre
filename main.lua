local service = 3217 -- Thay bằng Service ID từ Platoboost
local secret = "b4fc504c-13ea-4c85-b632-0e9419ddf993" -- Thay bằng API Secret Key từ Platoboost
local useNonce = true
...
local Window = WindUI:CreateWindow({
    ...
    KeySystem = { 
        ...
        URL = "", -- Để trống để vô hiệu hóa link mặc định
        SaveKey = true,
        Thumbnail = {
...
local function overrideKeySystem()
    ...
    getKeyButton.MouseButton1Click:Connect(function()
        ...
        if success then
            ...
            WindUI:Notify({
                Title = "Lion Hub",
                Content = "Không thể lấy link key từ Platoboost.",
                Duration = 5
            })
        end
    end)
